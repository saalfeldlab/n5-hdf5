 ...
 * @author Igor Pisarev
 */
public class N5HDF5Test {

	static private String testDirPath = System.getProperty("user.home") + "/tmp/n5-test.hdf5";
	...
	public void testWriteReadByteBlock() {
		...
		for (final CompressionType compressionType : new CompressionType[]{CompressionType.RAW, CompressionType.GZIP}) {
